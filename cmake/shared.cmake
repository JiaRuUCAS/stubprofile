set (STUBPROFILE_MAJOR_VERSION 0)
set (STUBPROFILE_MINOR_VERSION 1)
set (STUBPROFILE_PATCH_VERSION 0)

set (SOVERSION "${STUBPROFILE_MAJOR_VERSION}.${STUBPROFILE_MINOR_VERSION}")
set (LIBVERSION "${SOVERSION}.${STUBPROFILE_PATCH_VERSION}")
set (STUBPROFILE_VERSION "${LIBVERSION}")
...
set(ALL_STUBPROFILE_TARGETS "" CACHE INTERNAL "")
...
#  configure_file("${PROJECT_SOURCE_DIR}/cmake/${PROJECT_NAME}Config.cmake.in" "${PROJECT_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/${PROJECT_NAME}Config.cmake" @ONLY)
#  configure_file("${PROJECT_SOURCE_DIR}/cmake/${PROJECT_NAME}ConfigVersion.cmake.in" "${PROJECT_BINARY_DIR}/${CMAKE_FILES_DIRECTORY}/${PROJECT_NAME}ConfigVersion.cmake" @ONLY)
#  install (FILES
...
include (${PROJECT_SOURCE_DIR}/cmake/cap_arch_def.cmake)
include (${PROJECT_SOURCE_DIR}/cmake/visibility.cmake)
include (${PROJECT_SOURCE_DIR}/cmake/warnings.cmake)
#include (${PROJECT_SOURCE_DIR}/cmake/options.cmake)
include (${PROJECT_SOURCE_DIR}/cmake/optimization.cmake)
include (${PROJECT_SOURCE_DIR}/cmake/endian.cmake)
...
foreach (p BIN LIB INCLUDE CMAKE)
  ...
  if (NOT IS_ABSOLUTE "${${var}}")
	set (${var} "${DYNINST_TINY_BUILD_PATH}/${${var}}")
  endif()
endforeach()
