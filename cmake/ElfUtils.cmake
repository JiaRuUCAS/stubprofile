...
# libelf directory hints
foreach(d ROOT_DIR INCLUDEDIR LIBRARYDIR)
	set(${libElf}_${d} ${ElfUtils_${d}})
endforeach()
...
if(LibElf_FOUND)
  ...
  set(_eu_inc_dirs ${LibElf_INCLUDE_DIRS})
  set(_eu_lib_dirs ${LibElf_LIBRARY_DIRS})
  set(_eu_libs ${LibElf_LIBRARIES})
  ...
  externalproject_add(
    ...
    CONFIGURE_COMMAND
      ...
      --enable-install-elfh
	  --prefix=${DYNINST_TINY_BUILD_PATH}
    BUILD_COMMAND make install
    INSTALL_COMMAND ""
  )

  set(_eu_root ${DYNINST_TINY_BUILD_PATH})
  set(_eu_inc_dirs ${DYNINST_TINY_BUILD_PATH}/include
      ${DYNINST_TINY_BUILD_PATH}/include/elfutils)
  set(_eu_lib_dirs ${DYNINST_TINY_BUILD_PATH}/lib
      ${DYNINST_TINY_BUILD_PATH}/lib/elfutils)
  set(_eu_libs ${_eu_root}/lib/libelf.so)
endif()
